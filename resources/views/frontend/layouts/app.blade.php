...
<head>
    ...
    <title>@yield('title', 'DEFAULT_TITLE', 'Nectar Fashion')</title>
    ...
    <!-- Google tag (gtag.js) --> 
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-H2XZXBN88K"></script> 
    <script> 
...
<body>
    ...
    <div id="loader" class="loader">
        ...
        {{-- <div class="loader-text">Nectar Fashion</div> --}}
    </div>

    {{-- <div id="page-content">
        <h1>Welcome to Nectar Fashion!</h1>
        ...
        <div class="container">
            <div class="d-flex justify-content-center align-items-center">
                <div class="wholesale">
                    ...
                    <div class="btn">
                        <a class="btn after-regiseter-btn">Your minimum order must be above ${{@$settings[10]->value}}</a>
                    </div>
                    @else
                    {{-- <div class="btn">
            ...
            <div class="hr-wrap">
                <div class="mobile-pane-left">
                    ...
                    <div class="brand-logo">
                        ...
                        <a href="{{ url('/') }}"><img src="{{ $system_setting->value }}" alt="Logo"></a>
                    </div>
                </div>
                <div class="web_search_pannel desktop-only-panel">
                    <form action="{{ route('search') }}" method="get" class="search_box voice-data-submit">
