                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>{{ @$product->qty }}</td>
                            <td>AU ${{ formattedNepaliNumber(@$product->price) }}</td>
                            <td>AU ${{ formattedNepaliNumber(@$product->discount*@$product->qty) }}</td>
                            <td>AU ${{ formattedNepaliNumber(@$product->sub_total_price-@$product->vatamountfield) }}</td>
                        </tr>
                    @endforeach
                    <tr>
                        <td></td>
                        ...
                        <td></td>
                        <td></td>
                        <td><b>AU ${{ formattedNepaliNumber($data->sum('sub_total_price')-@$data->sum('vatamountfield')) }}</b></td>
                    </tr>
                    <tr>
                        ...
                        <td><strong>AU ${{formattedNepaliNumber(@$order->shipping_charge)}}</strong></td>
                        
                    </tr>
                    @if(@$order->material_charge)
                    <tr>
                        <td>Material Charge:</td>
                        <td><strong>AU ${{formattedNepaliNumber(@$order->material_charge)}}</strong></td>
                    </tr>
                    @endif
                    @if($order->coupon_discount_price !=0)
                    <tr>
                        <td>Coupon Discount:</td>
                        <td><strong>AU ${{formattedNepaliNumber(@$order->coupon_discount_price)}}</strong></td>
                    </tr>
                    @endif
                    ...
                    <tr>
                        <td>Grand Total:</td>
                        <td><strong>AU ${{ formattedNepaliNumber(@$order->total_price) }}</strong></td>
                    </tr>
                </tbody>
            </table>
        @endif
