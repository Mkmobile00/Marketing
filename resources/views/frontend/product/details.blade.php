                                            ...
                                            <div class="product-content">
                                                ...
                                                <div class="price-group">
                                                    <div class="old-price-list">
                                                        <span class="price_list">AU $20,000</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="brand-price" id="stock_price" style="display:flex; gap:9px; align-items:center;">
                                                @if (@$final_data['selected_data']['offer_price'][0] != null)
                                                    <span class="offer_price">
                                                        AU ${{ formattedNepaliNumber($final_data['selected_data']['offer_price'][0]) }}
                                                    </span>
                                                    <div class="detail_discount">
                                                        <del class="original_price">
                                                            AU ${{ formattedNepaliNumber($final_data['selected_data']['original_price'][0]) }}
                                                ...
                                                @elseif(
                                                    ...
                                                    <span class="special_price">
                                                        AU ${{ formattedNepaliNumber($final_data['selected_data']['special_price'][0]) }}
                                                    </span>
                                                    <div class="detail_discount">
                                                        <del class="original_price">
                                                            AU ${{ formattedNepaliNumber(@$final_data['selected_data']['original_price'][0]) }}
                                        ...
                                        @endforeach --}}
                                            @foreach ($related_product->stocks as $key => $stock)
                                                @if ($key == 0)
                                                    ...
                                                    @endphp
                                                    @if ($offer != null)
                                                        <del class="enable-del">
                                                            AU ${{ formattedNepaliNumber($stock->price) }}</del>
                                                        {{-- @if ($stock->special_price != null)
                                                            <del class="enable-del">$. {{ formattedNepaliNumber($stock->special_price) }}</del>
                                                        @endif --}}
                                                        <p class="price_list">AU ${{ formattedNepaliNumber($offer) }}</p>
                                                    @elseif($stock->special_price)
                                                        <del class="enable-del">
                                                            AU ${{ formattedNepaliNumber($stock->price) }}</del>
                                                        <p class="price_list">
                                                            AU ${{ formattedNepaliNumber($stock->special_price) }}
                                                        </p>
                                                    @else
                                                        <p class="price_list">
                                                            AU ${{ formattedNepaliNumber($stock->price) }}</p>
                                                    @endif
                                                @endif
                                            @endforeach
                                        </div>
