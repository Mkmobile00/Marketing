                    ...
                    <div class="checkout_detail_wrap">
                        ...
                        <div class="pt-totals">
                            <ul>
                                <li hidden>
                                    <span>Sub Total</span>
                                    <b class="all_sub_total">AU ${{ $sub_total }}</b>
                                </li>

                                <li>
                                    <span>Sub Total</span>
                                    <b class="">AU ${{ $sub_total-$vatAmount }}</b>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <b class="material_charge">AU ${{ @$material_charge }}</b>
                                </li>
                                @endif
                                <li>
                                ...
                                <li>
                                    <span>Total</span>
                                    <b class="allTotal" data-totalAmount="{{ $sub_total }}">AU ${{ $sub_total + $default_shipping_charge + @$material_charge }}
                                    </b>
                                </li>
                            </ul>
                        </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.error) {
                            ...
                            $('.found').hide();
                            $('.not_found').show();
                            $('.allTotal').text('AU $ ' + (parseInt(shipping_charge) + parseInt(
                                total_amount)));
                            ...
                            if (response.data) {
                                ...
                                $('.found').text('- $. ' + amount);
                                $('.allTotal').text('AU $ ' + (parseInt(shipping_charge) +
