                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="form-check">
                                            ...
                                            <label for="flexRadioDefault1" class="form-check-label"><img
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4" id="qrImage" style="display: none;">
                            ...
                            <ul>
                                ...
                                {{-- @dd($item) --}}
                                    <li>
                                        ...
                                        <div class="tp-right">
                                            <b>AU ${{ number_format($item->sub_total_price) }}</b>
                                        </div>
                                    </li>
                                @endforeach
                            </ul>
                        ...
                        <div class="pt-totals">
                            <ul>
                                <li>
                                    ...
                                    <b class="after_coupon">AU ${{ number_format(@$total_amount) }}</b>
                                </li>
                                <li>
                                    {{-- zzz --}}
                                    <span>Shipping Charge</span>
                                    <b class="shipping_charge">AU ${{ @$default_shipping_charge }}</b>
                                </li>
                                @if($default_material_charge > 0)
                                <li>
                                    <span>Material  Charge</span>
                                    <b class="shipping_charge">AU ${{ @$default_material_charge }}</b>
                                </li>
                                @endif
                                <li>
                                    <span>Coupon Price</span>
                                    <b class="found">AU $0</b>
                                </li>
                                <li>
                                    <span>Total</span>
                                    <p class="hidden_amount" hidden>{{ @$total_amount }}</p>
                                    <b class="allTotal" id="items_total_cost" data-totalAmount="{{ @$total_amount }}">AU ${{ @$total_amount + @$default_shipping_charge + @$default_material_charge  }}</b>
                                </li>
                            </ul>
                        </div>
                    </div>
